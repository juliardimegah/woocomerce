...
<form name="caddy-form" id="caddy-offers-form" method="post" action="">
	...
	<div class="cc-settings-container">
		<h2><span class="section-icons"><img src="<?php echo esc_url( plugin_dir_url( CADDY_PLUGIN_FILE ) . 'admin/img/icon-offers.svg' ); ?>" /></span>&nbsp;<?php echo esc_html( __( 'Offers', 'caddy' ) ); ?></h2>
