...
<form name="caddy-form" id="caddy-announcement-bar-form" method="post" action="">
	...
	<div class="cc-settings-container">
		<h2><span class="section-icons"><img src="<?php echo esc_url( plugin_dir_url( CADDY_PLUGIN_FILE ) . 'admin/img/icon-announcement.svg' ); ?>" /></span>&nbsp;<?php echo esc_html( __( 'Announcement Bar', 'caddy' ) ); ?></h2>
		<p><?php esc_html_e('Customize the announcement text that shows in the Caddy cart.', 'caddy'); ?></p>
