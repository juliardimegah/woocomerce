...
if ( ! class_exists( 'Fitness_Elementor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Fitness_Elementor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'fitness_elementor_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function fitness_elementor_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Fitness_Elementor_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'fitness_elementor_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function fitness_elementor_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Fitness_Elementor_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
